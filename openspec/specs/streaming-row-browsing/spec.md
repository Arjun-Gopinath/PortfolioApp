...
Defines the streaming-service-style row/carousel browsing pattern used across Skills, Experience, Certifications, and Projects: horizontally-scrollable `Row` components of `TitleCard`s, replacing the previous static grid and pinned-scroll layouts.
